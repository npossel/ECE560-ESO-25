...
#define PROFILER_SAMPLE_FREQ_HZ (50000)  // pick to avoid synchronization
...
#define IRQ_FRAME_SIZE (16)  // depends on IRQhandler, compiler settings. AC6 -O3 MicroLib: 16
#define PPS_FRAME_SIZE (20)  // depends on PPS code and compiler settings
