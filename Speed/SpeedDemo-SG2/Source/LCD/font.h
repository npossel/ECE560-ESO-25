...
#define FONTS_IN_APPLICATION (1) // Put fonts in application (1) or overlay memory (0)
...
#if FONTS_IN_APPLICATION // Need to be careful, since limited memory!
	#define P_LUCIDA_CONSOLE8x13 	 ((const uint8_t *) 0)
	#define P_LUCIDA_CONSOLE12x19  (Lucida_Console12x19)
	#define P_LUCIDA_CONSOLE20x31  ((const uint8_t *) 0)
